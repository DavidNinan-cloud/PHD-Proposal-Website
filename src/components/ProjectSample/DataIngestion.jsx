      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-12 border-l-4 border-[#003399] pl-6">
          ...
          <p className="text-slate-600 mt-2 max-w-3xl">
            To prevent "Boiling the Ocean," the TRACE-EU framework bounds ingestion by the **EU Critical Raw Materials Act** ontology—focusing exclusively on high-impact causal pathways for strategic autonomy[cite: 101].
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-bold text-slate-800 uppercase tracking-widest text-sm">Textual Signal Layer [cite: 99]</h3>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-bold text-slate-800 uppercase tracking-widest text-sm">Physical Outcome Layer [cite: 100]</h3>
            </div>
          ...
          <div className="bg-[#0f172a] rounded-2xl p-8 text-white shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-[#FFCC00] font-bold uppercase tracking-widest text-xs mb-6">Topic-Aware Gating [cite: 96]</h3>
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="flex items-start gap-3 p-4 bg-amber-900/20 border border-amber-900/50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">1,402 signals discarded this hour (Irrelevant to EU strategic commodities)[cite: 78].</p>
                </div>
              </div>
            </div>
          </div>
