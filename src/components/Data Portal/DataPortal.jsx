...
const DataPortal = () => {
  ...
  const systemStatus = [
    { label: "JTS Encoder", status: "Active", detail: "RoBERTa-Backbone" }, 
    { label: "Causal Mechanism", status: "Ready", detail: "PCMCI Algorithm" }, 
    { label: "Ontology Filter", status: "Live", detail: "EU CRM Act List" } 
  ];
    ...
    <div id='portal-main' className="bg-[#fcfcfc] min-h-screen pt-12 pb-24 font-Nunito">
      ...
      <main className="max-w-[1440px] mx-auto px-8 grid lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-9 space-y-6">
              ...
              {activeTab === 'causal' && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full">
                  ...
                  <p className="text-slate-500 mb-8 max-w-lg mx-auto italic text-sm">
                    Quantifying causal propagation from Geopolitical Stance Shifts to European Value Chain disruption.
                  </p>
          ...
          {/* Bottom Terminal Insight (JTS Inference Stream)  */}
          <div className="bg-[#0f172a] rounded-xl p-5 font-mono text-xs shadow-2xl overflow-hidden border-l-4 border-[#FFCC00]">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-400">[{new Date().toLocaleTimeString()}] CAUSAL_PATH: Rhetoric → Inventory_Hoarding → Volume_Drop </p>
            </div>
          </div>
